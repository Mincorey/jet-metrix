...
import handler_0 from './_lib/routes/backup';
import handler_1 from './_lib/routes/daily-measurements/latest/[tankName]';
import handler_2 from './_lib/routes/daily-measurements';
import handler_3 from './_lib/routes/dashboard/activity';
import handler_4 from './_lib/routes/dashboard/summary';
import handler_5 from './_lib/routes/dashboard/timeline/[workdayId]';
import handler_6 from './_lib/routes/database/clear-operations';
import handler_7 from './_lib/routes/employees/all';
import handler_8 from './_lib/routes/employees/[id]/status';
import handler_9 from './_lib/routes/employees/[id]';
import handler_10 from './_lib/routes/employees';
import handler_11 from './_lib/routes/fuel-dispensing-tza';
import handler_12 from './_lib/routes/fuel-dispensing-vs';
import handler_13 from './_lib/routes/fuel-reception-auto';
import handler_14 from './_lib/routes/fuel-reception';
import handler_15 from './_lib/routes/in-warehouse';
import handler_16 from './_lib/routes/inventory';
import handler_17 from './_lib/routes/operations/edit-last';
import handler_18 from './_lib/routes/operations/last/[workdayId]';
import handler_19 from './_lib/routes/park-state';
import handler_20 from './_lib/routes/send-checklist';
import handler_21 from './_lib/routes/settings/logo';
import handler_22 from './_lib/routes/settings/telegram/test';
import handler_23 from './_lib/routes/settings/telegram';
import handler_24 from './_lib/routes/settings/texts';
import handler_25 from './_lib/routes/stock';
import handler_26 from './_lib/routes/system/core-metrics';
import handler_27 from './_lib/routes/system/setup-status';
import handler_28 from './_lib/routes/system/setup';
import handler_29 from './_lib/routes/tanks/all';
import handler_30 from './_lib/routes/tanks/[id]/status';
import handler_31 from './_lib/routes/tanks';
import handler_32 from './_lib/routes/tech-lines/[id]';
import handler_33 from './_lib/routes/tech-lines';
import handler_34 from './_lib/routes/telegram/webhook';
import handler_35 from './_lib/routes/train-report';
import handler_36 from './_lib/routes/trains';
import handler_37 from './_lib/routes/tza/[id]/monitoring';
import handler_38 from './_lib/routes/tza/[id]';
import handler_39 from './_lib/routes/tza';
import handler_40 from './_lib/routes/workdays/close';
import handler_41 from './_lib/routes/workdays/start';
import handler_42 from './_lib/routes/workdays';
