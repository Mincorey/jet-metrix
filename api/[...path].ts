...
import handler_0 from '../lib/routes/backup';
import handler_1 from '../lib/routes/daily-measurements/latest/[tankName]';
import handler_2 from '../lib/routes/daily-measurements';
import handler_3 from '../lib/routes/dashboard/activity';
import handler_4 from '../lib/routes/dashboard/summary';
import handler_5 from '../lib/routes/dashboard/timeline/[workdayId]';
import handler_6 from '../lib/routes/database/clear-operations';
import handler_7 from '../lib/routes/employees/all';
import handler_8 from '../lib/routes/employees/[id]/status';
import handler_9 from '../lib/routes/employees/[id]';
import handler_10 from '../lib/routes/employees';
import handler_11 from '../lib/routes/fuel-dispensing-tza';
import handler_12 from '../lib/routes/fuel-dispensing-vs';
import handler_13 from '../lib/routes/fuel-reception-auto';
import handler_14 from '../lib/routes/fuel-reception';
import handler_15 from '../lib/routes/in-warehouse';
import handler_16 from '../lib/routes/inventory';
import handler_17 from '../lib/routes/operations/edit-last';
import handler_18 from '../lib/routes/operations/last/[workdayId]';
import handler_19 from '../lib/routes/park-state';
import handler_20 from '../lib/routes/send-checklist';
import handler_21 from '../lib/routes/settings/logo';
import handler_22 from '../lib/routes/settings/telegram/test';
import handler_23 from '../lib/routes/settings/telegram';
import handler_24 from '../lib/routes/settings/texts';
import handler_25 from '../lib/routes/stock';
import handler_26 from '../lib/routes/system/core-metrics';
import handler_27 from '../lib/routes/system/setup-status';
import handler_28 from '../lib/routes/system/setup';
import handler_29 from '../lib/routes/tanks/all';
import handler_30 from '../lib/routes/tanks/[id]/status';
import handler_31 from '../lib/routes/tanks';
import handler_32 from '../lib/routes/tech-lines/[id]';
import handler_33 from '../lib/routes/tech-lines';
import handler_34 from '../lib/routes/telegram/webhook';
import handler_35 from '../lib/routes/train-report';
import handler_36 from '../lib/routes/trains';
import handler_37 from '../lib/routes/tza/[id]/monitoring';
import handler_38 from '../lib/routes/tza/[id]';
import handler_39 from '../lib/routes/tza';
import handler_40 from '../lib/routes/workdays/close';
import handler_41 from '../lib/routes/workdays/start';
import handler_42 from '../lib/routes/workdays';
