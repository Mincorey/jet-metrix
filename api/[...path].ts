...
import handler_0 from './_handlers/backup';
import handler_1 from './_handlers/daily-measurements/latest/[tankName]';
import handler_2 from './_handlers/daily-measurements';
import handler_3 from './_handlers/dashboard/activity';
import handler_4 from './_handlers/dashboard/summary';
import handler_5 from './_handlers/dashboard/timeline/[workdayId]';
import handler_6 from './_handlers/database/clear-operations';
import handler_7 from './_handlers/employees/all';
import handler_8 from './_handlers/employees/[id]/status';
import handler_9 from './_handlers/employees/[id]';
import handler_10 from './_handlers/employees';
import handler_11 from './_handlers/fuel-dispensing-tza';
import handler_12 from './_handlers/fuel-dispensing-vs';
import handler_13 from './_handlers/fuel-reception-auto';
import handler_14 from './_handlers/fuel-reception';
import handler_15 from './_handlers/in-warehouse';
import handler_16 from './_handlers/inventory';
import handler_17 from './_handlers/operations/edit-last';
import handler_18 from './_handlers/operations/last/[workdayId]';
import handler_19 from './_handlers/park-state';
import handler_20 from './_handlers/send-checklist';
import handler_21 from './_handlers/settings/logo';
import handler_22 from './_handlers/settings/telegram/test';
import handler_23 from './_handlers/settings/telegram';
import handler_24 from './_handlers/settings/texts';
import handler_25 from './_handlers/stock';
import handler_26 from './_handlers/system/core-metrics';
import handler_27 from './_handlers/system/setup-status';
import handler_28 from './_handlers/system/setup';
import handler_29 from './_handlers/tanks/all';
import handler_30 from './_handlers/tanks/[id]/status';
import handler_31 from './_handlers/tanks';
import handler_32 from './_handlers/tech-lines/[id]';
import handler_33 from './_handlers/tech-lines';
import handler_34 from './_handlers/telegram/webhook';
import handler_35 from './_handlers/train-report';
import handler_36 from './_handlers/trains';
import handler_37 from './_handlers/tza/[id]/monitoring';
import handler_38 from './_handlers/tza/[id]';
import handler_39 from './_handlers/tza';
import handler_40 from './_handlers/workdays/close';
import handler_41 from './_handlers/workdays/start';
import handler_42 from './_handlers/workdays';
