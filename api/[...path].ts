...
import handler_0 from '../server/routes/backup';
import handler_1 from '../server/routes/daily-measurements/latest/[tankName]';
import handler_2 from '../server/routes/daily-measurements';
import handler_3 from '../server/routes/dashboard/activity';
import handler_4 from '../server/routes/dashboard/summary';
import handler_5 from '../server/routes/dashboard/timeline/[workdayId]';
import handler_6 from '../server/routes/database/clear-operations';
import handler_7 from '../server/routes/employees/all';
import handler_8 from '../server/routes/employees/[id]/status';
import handler_9 from '../server/routes/employees/[id]';
import handler_10 from '../server/routes/employees';
import handler_11 from '../server/routes/fuel-dispensing-tza';
import handler_12 from '../server/routes/fuel-dispensing-vs';
import handler_13 from '../server/routes/fuel-reception-auto';
import handler_14 from '../server/routes/fuel-reception';
import handler_15 from '../server/routes/in-warehouse';
import handler_16 from '../server/routes/inventory';
import handler_17 from '../server/routes/operations/edit-last';
import handler_18 from '../server/routes/operations/last/[workdayId]';
import handler_19 from '../server/routes/park-state';
import handler_20 from '../server/routes/send-checklist';
import handler_21 from '../server/routes/settings/logo';
import handler_22 from '../server/routes/settings/telegram/test';
import handler_23 from '../server/routes/settings/telegram';
import handler_24 from '../server/routes/settings/texts';
import handler_25 from '../server/routes/stock';
import handler_26 from '../server/routes/system/core-metrics';
import handler_27 from '../server/routes/system/setup-status';
import handler_28 from '../server/routes/system/setup';
import handler_29 from '../server/routes/tanks/all';
import handler_30 from '../server/routes/tanks/[id]/status';
import handler_31 from '../server/routes/tanks';
import handler_32 from '../server/routes/tech-lines/[id]';
import handler_33 from '../server/routes/tech-lines';
import handler_34 from '../server/routes/telegram/webhook';
import handler_35 from '../server/routes/train-report';
import handler_36 from '../server/routes/trains';
import handler_37 from '../server/routes/tza/[id]/monitoring';
import handler_38 from '../server/routes/tza/[id]';
import handler_39 from '../server/routes/tza';
import handler_40 from '../server/routes/workdays/close';
import handler_41 from '../server/routes/workdays/start';
import handler_42 from '../server/routes/workdays';
