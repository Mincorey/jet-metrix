...
import handler_0 from '../lib/handlers/backup';
import handler_1 from '../lib/handlers/daily-measurements/latest/[tankName]';
import handler_2 from '../lib/handlers/daily-measurements';
import handler_3 from '../lib/handlers/dashboard/activity';
import handler_4 from '../lib/handlers/dashboard/summary';
import handler_5 from '../lib/handlers/dashboard/timeline/[workdayId]';
import handler_6 from '../lib/handlers/database/clear-operations';
import handler_7 from '../lib/handlers/employees/all';
import handler_8 from '../lib/handlers/employees/[id]/status';
import handler_9 from '../lib/handlers/employees/[id]';
import handler_10 from '../lib/handlers/employees';
import handler_11 from '../lib/handlers/fuel-dispensing-tza';
import handler_12 from '../lib/handlers/fuel-dispensing-vs';
import handler_13 from '../lib/handlers/fuel-reception-auto';
import handler_14 from '../lib/handlers/fuel-reception';
import handler_15 from '../lib/handlers/in-warehouse';
import handler_16 from '../lib/handlers/inventory';
import handler_17 from '../lib/handlers/operations/edit-last';
import handler_18 from '../lib/handlers/operations/last/[workdayId]';
import handler_19 from '../lib/handlers/park-state';
import handler_20 from '../lib/handlers/send-checklist';
import handler_21 from '../lib/handlers/settings/logo';
import handler_22 from '../lib/handlers/settings/telegram/test';
import handler_23 from '../lib/handlers/settings/telegram';
import handler_24 from '../lib/handlers/settings/texts';
import handler_25 from '../lib/handlers/stock';
import handler_26 from '../lib/handlers/system/core-metrics';
import handler_27 from '../lib/handlers/system/setup-status';
import handler_28 from '../lib/handlers/system/setup';
import handler_29 from '../lib/handlers/tanks/all';
import handler_30 from '../lib/handlers/tanks/[id]/status';
import handler_31 from '../lib/handlers/tanks';
import handler_32 from '../lib/handlers/tech-lines/[id]';
import handler_33 from '../lib/handlers/tech-lines';
import handler_34 from '../lib/handlers/telegram/webhook';
import handler_35 from '../lib/handlers/train-report';
import handler_36 from '../lib/handlers/trains';
import handler_37 from '../lib/handlers/tza/[id]/monitoring';
import handler_38 from '../lib/handlers/tza/[id]';
import handler_39 from '../lib/handlers/tza';
import handler_40 from '../lib/handlers/workdays/close';
import handler_41 from '../lib/handlers/workdays/start';
import handler_42 from '../lib/handlers/workdays';
