...
import { withCors, sendError } from './_lib/helpers.js'

import handler_0 from './_handlers/backup.js';
import handler_1 from './_handlers/daily-measurements/latest/[tankName].js';
import handler_2 from './_handlers/daily-measurements.js';
import handler_3 from './_handlers/dashboard/activity.js';
import handler_4 from './_handlers/dashboard/summary.js';
import handler_5 from './_handlers/dashboard/timeline/[workdayId].js';
import handler_6 from './_handlers/database/clear-operations.js';
import handler_7 from './_handlers/employees/all.js';
import handler_8 from './_handlers/employees/[id]/status.js';
import handler_9 from './_handlers/employees/[id].js';
import handler_10 from './_handlers/employees.js';
import handler_11 from './_handlers/fuel-dispensing-tza.js';
import handler_12 from './_handlers/fuel-dispensing-vs.js';
import handler_13 from './_handlers/fuel-reception-auto.js';
import handler_14 from './_handlers/fuel-reception.js';
...
import handler_21 from './_handlers/settings/logo.js';
import handler_22 from './_handlers/settings/telegram/test.js';
import handler_23 from './_handlers/settings/telegram.js';
import handler_24 from './_handlers/settings/texts.js';
import handler_25 from './_handlers/stock.js';
import handler_26 from './_handlers/system/core-metrics.js';
import handler_27 from './_handlers/system/setup-status.js';
import handler_28 from './_handlers/system/setup.js';
import handler_29 from './_handlers/tanks/all.js';
import handler_30 from './_handlers/tanks/[id]/status.js';
import handler_31 from './_handlers/tanks.js';
import handler_32 from './_handlers/tech-lines/[id].js';
import handler_33 from './_handlers/tech-lines.js';
import handler_34 from './_handlers/telegram/webhook.js';
import handler_35 from './_handlers/train-report.js';
import handler_36 from './_handlers/trains.js';
import handler_37 from './_handlers/tza/[id]/monitoring.js';
